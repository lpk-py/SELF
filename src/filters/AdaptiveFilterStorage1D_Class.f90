! AdaptiveFilterStorage_1D_Class.f90 ( new with v2.1 - 21 March 2016)
! 
! ====================================== LICENSE ================================================= !
!
...
MODULE AdaptiveFilterStorage1D_Class
...
USE NodalStorage_1D_Class
   ...
   TYPE AdaptiveFilterStorage_1D
      ...
      PROCEDURE :: Build => Build_AdaptiveFilterStorage_1D
      PROCEDURE :: Trash => Trash_AdaptiveFilterStorage_1D
      ! 
      PROCEDURE :: SetNumberOfNodes => SetNumberOfNodes_AdaptiveFilterStorage_1D
      PROCEDURE :: GetNumberOfNodes => GetNumberOfNodes_AdaptiveFilterStorage_1D
      PROCEDURE :: SetCutoffs => SetCutoffs_AdaptiveFilterStorage_1D
      PROCEDURE :: GetCutoffs => GetCutoffs_AdaptiveFilterStorage_1D
      !
      PROCEDURE :: ApplyFilter => ApplyFilter_AdaptiveFilterStorage_1D
   END TYPE AdaptiveFilterStorage_1D
...
!
!
 SUBROUTINE Build_AdaptiveFilterStorage_1D( thisFilter, thisStorage, sCutoff )
 ! S/R Build
 !
 ...
 ! DECLARATIONS
   IMPLICIT NONE
   CLASS(AdaptiveFilterStorage_1D), INTENT(inout) :: thisFilter
 ...
 END SUBROUTINE Build_AdaptiveFilterStorage_1D
!
!
!
 SUBROUTINE Trash_AdaptiveFilterStorage_1D( thisFilter )
 ! S/R Trash
 ! 
 ! =============================================================================================== !
 ! DECLARATIONS
 ...
 END SUBROUTINE Trash_AdaptiveFilterStorage_1D
!
!
!==================================================================================================!
!--------------------------------------- Accessors ------------------------------------------------!
...
!
! 
 SUBROUTINE SetNumberOfNodes_AdaptiveFilterStorage_1D( thisFilter, nS )
 ...
 END SUBROUTINE SetNumberOfNodes_AdaptiveFilterStorage_1D
!
!
!
 SUBROUTINE GetNumberOfNodes_AdaptiveFilterStorage_1D( thisFilter, nS  )
 ...
 ! DECLARATIONS
    IMPLICIT NONE
    CLASS(AdaptiveFilterStorage_1D), INTENT(in) :: thisFilter
    INTEGER, INTENT(out)                        :: nS

      nS = thisFilter % nS

 END SUBROUTINE GetNumberOfNodes_AdaptiveFilterStorage_1D
!
!
!
 SUBROUTINE SetCutoffs_AdaptiveFilterStorage_1D( thisFilter, sCutoff )
 !
 !
 ! =============================================================================================== !
 ! DECLARATIONS
 ...
 END SUBROUTINE SetCutoffs_AdaptiveFilterStorage_1D
!
!
!
 SUBROUTINE GetCutoffs_AdaptiveFilterStorage_1D( thisFilter, sCutoff )
 !
 !
 ! =============================================================================================== !
 ! DECLARATIONS
 ...
 END SUBROUTINE GetCutoffs_AdaptiveFilterStorage_1D
!
!
!==================================================================================================!
!------------------------------------- Type Specific ----------------------------------------------!
...
!
! 
 FUNCTION ApplyFilter_AdaptiveFilterStorage_1D( thisFilter, sol ) RESULT(fSol)
 ! FUNCTION ApplyFilter
 !
 ! =============================================================================================== !
 ! DECLARATIONS
   IMPLICIT NONE
   CLASS(AdaptiveFilterStorage_1D) :: thisFilter
   REAL(prec)                      :: sol(0:thisFilter % nS)
   REAL(prec)                      :: fSol(0:thisFilter % nS)

      fSol = MATMUL( thisFilter % filterMat, sol )
      
 END FUNCTION ApplyFilter_AdaptiveFilterStorage_1D

END MODULE AdaptiveFilterStorage1D_Class
