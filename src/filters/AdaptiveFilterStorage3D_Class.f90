! AdaptiveFilterStorage_3D_Class.f90 ( new with v2.1 - 21 March 2016)
! 
! ====================================== LICENSE ================================================= !
!
...
MODULE AdaptiveFilterStorage3D_Class
...
USE NodalStorage_3D
   ...
   TYPE AdaptiveFilterStorage_3D
      ...
      PROCEDURE :: Build => Build_AdaptiveFilterStorage_3D
      PROCEDURE :: Trash => Trash_AdaptiveFilterStorage_3D
      ! 
      PROCEDURE :: SetNumberOfNodes => SetNumberOfNodes_AdaptiveFilterStorage_3D
      PROCEDURE :: GetNumberOfNodes => GetNumberOfNodes_AdaptiveFilterStorage_3D


   END TYPE AdaptiveFilterStorage_3D
...
!
!
 SUBROUTINE Build_AdaptiveFilterStorage_3D( thisFilter, thisStorage, sCutoff, pCutoff, qCutoff )
 ! S/R Build
 !
 ...
 ! DECLARATIONS
   IMPLICIT NONE
   CLASS(AdaptiveFilterStorage_3D), INTENT(inout) :: thisFilter
 ...
 END SUBROUTINE Build_AdaptiveFilterStorage_3D
!
!
!
 SUBROUTINE Trash_AdaptiveFilterStorage_3D( thisFilter )
 ! S/R Trash
 ! 
 ! =============================================================================================== !
 ! DECLARATIONS
 ...
 END SUBROUTINE Trash_AdaptiveFilterStorage_3D
!
!
!==================================================================================================!
!--------------------------------------- Accessors ------------------------------------------------!
...
!
! 
 SUBROUTINE SetNumberOfNodes_AdaptiveFilterStorage_3D( thisFilter, nS, nP, nQ  )
 ...
 END SUBROUTINE SetNumberOfNodes_AdaptiveFilterStorage_3D
!
!
!
 SUBROUTINE GetNumberOfNodes_AdaptiveFilterStorage_3D( thisFilter, nS, nP, nQ  )
 ...
 ! DECLARATIONS
    IMPLICIT NONE
    CLASS(AdaptiveFilterStorage_3D), INTENT(in) :: thisFilter
 ...
 END SUBROUTINE GetNumberOfNodes_AdaptiveFilterStorage_3D
!
!
!
!
...
!
! 
 FUNCTION ApplyFilter_AdaptiveFilterStorage_3D( thisFilter, sol ) RESULT(fSol)
 ! FUNCTION ApplyFilter
 !
 ! =============================================================================================== !
 ! DECLARATIONS
   IMPLICIT NONE
   CLASS(AdaptiveFilterStorage_3D) :: thisFilter
 ...
 END FUNCTION ApplyFilter_AdaptiveFilterStorage_3D

END MODULE AdaptiveFilterStorage3D_Class
