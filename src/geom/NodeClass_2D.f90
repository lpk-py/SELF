...
!
!
 SUBROUTINE Build_Node( thisNode, x, y )
 ! S/R Build_Node
 !  
 !
 ! =============================================================================================== !
...
!
!
 SUBROUTINE SetCurrentData_NodeList( myList, x, y, nodeType )
 ! S/R SetCurrentData
 !
 !
 ! ========================================================================== !
...
!
!
 SUBROUTINE GetCurrentData_NodeList( myList, x, y, nodeType )
 ! S/R GetCurrentData
 !
 !
 ! ========================================================================== !
...
!
!
 SUBROUTINE SetCurrentPosition_NodeList( myList, x, y )
...
!
!
 SUBROUTINE GetCurrentPosition_NodeList( myList, x, y )
...
!
!
 SUBROUTINE SetData_Node( thisNode, x, y, nodeType )
 ! S/R SetData
 !  
 !
 ! =============================================================================================== !
...
!
!
 SUBROUTINE GetData_Node( thisNode, x, y, nodeType )
 ! S/R GetData
 !  
 !
 ! =============================================================================================== !
...
! --------------------------------------- Position ----------------------------------------------- !
!
 SUBROUTINE GetPosition_Node( thisNode, x, y )
...
!
!
 SUBROUTINE SetPosition_Node( thisNode, x, y )
...
!
!
 SUBROUTINE AddToList_NodeList( myList, x, y, nodeType, inKey )
 ! S/R AddToList
 !
...
!
!
 SUBROUTINE ScaleNodePosition_Node( myNode, xScale, yScale )
 ! S/R ScaleNode
 ! 
 ! =============================================================================================== !
 ! DECLARATIONS
