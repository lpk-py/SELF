! LBSWClass.f90 ( new with v2.1 - 27 Jan. 2016)
! 
! ====================================== LICENSE ================================================= !
!
...
! ================================================================================================ !  
    ...
    TYPE LBSW
      ...
      REAL(prec), ALLOCATABLE               :: vorticity(:,:,:)
      ...
      PROCEDURE :: GetVelocity => GetVelocity_LBSW
      PROCEDURE :: SetVelocity => SetVelocity_LBSW
      PROCEDURE :: GetVelocityAtBoundary => GetVelocityAtBoundary_LBSW
      PROCEDURE :: SetVelocityAtBoundary => SetVelocityAtBoundary_LBSW
      ...
      PROCEDURE :: EdgeGradientFlux => EdgeGradientFlux_LBSW
      ...
      PROCEDURE :: CalculateVelocityAtBoundaries => CalculateVelocityAtBoundaries_LBSW
...
!
!
 SUBROUTINE GetVelocity_LBSW( myDGSEM, iEl, u, v  )
 ! S/R GetVelocity
 !  
 !
 ! =============================================================================================== !
 ...
 END SUBROUTINE GetVelocity_LBSW
!
!
!
 SUBROUTINE SetVelocity_LBSW( myDGSEM, iEl, u, v  )
 ! S/R SetVelocity
 !  
 !
 ! =============================================================================================== !
 ...
 END SUBROUTINE SetVelocity_LBSW
!
!
!
 SUBROUTINE GetVelocityAtBoundary_LBSW( myDGSEM, iEl, boundary, u, v  )
 ...
 END SUBROUTINE GetVelocityAtBoundary_LBSW
!
!
!
 SUBROUTINE SetVelocityAtBoundary_LBSW( myDGSEM, iEl, boundary, u, v  )
 ...
 END SUBROUTINE SetVelocityAtBoundary_LBSW
!
!
!
...
! ----------------------------------------- Gradient --------------------------------------------- !
!
 SUBROUTINE GetGradient_LBSW( myDGSEM, iEl, dcdx, dcdy  )
 ! S/R GetGradient
 !  
 !
 ! =============================================================================================== !
 ...
 END SUBROUTINE GetGradient_LBSW
!
!
!
 SUBROUTINE SetGradient_LBSW( myDGSEM, iEl, dcdx, dcdy  )
 ! S/R SetGradient
 !  
 !
 ! =============================================================================================== !
 ...
 END SUBROUTINE SetGradient_LBSW
!
!
!
 SUBROUTINE GetGradientAtNode_LBSW( myDGSEM, iEl, i, j, dcdx, dcdy  )
 ...
 END SUBROUTINE GetGradientAtNode_LBSW
!
!
!
 SUBROUTINE SetGradientAtNode_LBSW( myDGSEM, iEl, i, j, dcdx, dcdy  )
 ...
 END SUBROUTINE SetGradientAtNode_LBSW
!
!
!
SUBROUTINE GetGradientWithVarID_LBSW( myDGSEM, iEl, varID, dcdx, dcdy  )
 ! S/R GetGradient
 !  
 !
 ! =============================================================================================== !
 ...
 END SUBROUTINE GetGradientWithVarID_LBSW
!
!
!
 SUBROUTINE SetGradientWithVarID_LBSW( myDGSEM, iEl, varID, dcdx, dcdy  )
 ! S/R SetGradient
 !  
 !
 ! =============================================================================================== !
 ...
 END SUBROUTINE SetGradientWithVarID_LBSW
!
! ------------------------------- Boundary Solution ---------------------------------------------- !
!
...
! ------------------------------- Boundary Gradient ---------------------------------------------- !
!
 SUBROUTINE GetBoundaryGradientAtBoundary_LBSW( myDGSEM, iEl, boundary, dcdx, dcdy  )
 ...
 END SUBROUTINE GetBoundaryGradientAtBoundary_LBSW
!
!
!
 SUBROUTINE SetBoundaryGradientAtBoundary_LBSW( myDGSEM, iEl, boundary, dcdx, dcdy  )
 ...
 END SUBROUTINE SetBoundaryGradientAtBoundary_LBSW
!
! --------------------------------- Boundary Flux ------------------------------------------------ !
!
...
! --------------------------------- Relaxation Field --------------------------------------------- !
!
 SUBROUTINE GetRelaxationField_LBSW( myDGSEM, iEl, relaxField  )
 ...
 END SUBROUTINE GetRelaxationField_LBSW
!
!
!
 SUBROUTINE SetRelaxationField_LBSW( myDGSEM, iEl, relaxField  )
 ...
 END SUBROUTINE SetRelaxationField_LBSW
!
!
!
 SUBROUTINE GetRelaxationFieldAtNode_LBSW( myDGSEM, iEl, i, j, relaxField  )
 ! S/R GetRelaxationField
 !  
 !
 ! =============================================================================================== !
 ...
 END SUBROUTINE GetRelaxationFieldAtNode_LBSW
!
!
!
 SUBROUTINE SetRelaxationFieldAtNode_LBSW( myDGSEM, iEl, i, j, relaxField  )
 ...
 END SUBROUTINE SetRelaxationFieldAtNode_LBSW
!
!
!
 SUBROUTINE GetRelaxationFactor_LBSW( myDGSEM, iEl, rFac  )
 ...
 END SUBROUTINE GetRelaxationFactor_LBSW
!
!
!
 SUBROUTINE SetRelaxationFactor_LBSW( myDGSEM, iEl, rFac  )
 ...
 END SUBROUTINE SetRelaxationFactor_LBSW
!
!
!
 SUBROUTINE GetRelaxationFactorAtNode_LBSW( myDGSEM, iEl, i, j, rFac  )
 ! S/R GetRelaxationFactor
 !  
 !
 ! =============================================================================================== !
 ...
 END SUBROUTINE GetRelaxationFactorAtNode_LBSW
!
!
!
 SUBROUTINE SetRelaxationFactorAtNode_LBSW( myDGSEM, iEl, i, j, rFac  )
 ...
 END SUBROUTINE SetRelaxationFactorAtNode_LBSW
!
!
!==================================================================================================!
!--------------------------------- Type Specific Routines -----------------------------------------!
...
!
!
 SUBROUTINE CalculateGradientAtBoundaries_LBSW( myDGSEM, iEl )
 ...
 END SUBROUTINE CalculateGradientAtBoundaries_LBSW
!
!
!
 SUBROUTINE CalculateVelocityAtBoundaries_LBSW( myDGSEM, iEl )
 ...
 END SUBROUTINE CalculateVelocityAtBoundaries_LBSW
!
!
!
 SUBROUTINE CalculateConcentrationGradient_LBSW( myDGSEM, iEl ) 
 ...
 END SUBROUTINE CalculateConcentrationGradient_LBSW
!
!
!
...
!
!
SUBROUTINE EdgeGradientFlux_LBSW( myDGSEM, iEdge, tn )
 ...
 END SUBROUTINE EdgeGradientFlux_LBSW
!
!
!
...
!
!
 SUBROUTINE CoarseToFine_LBSW( myDGSEM, iEl, x, y, u, v, c, dcdx, dcdy )
 ! CoarseToFine
 !
 ! =============================================================================================== !
 ! DECLARATIONS
