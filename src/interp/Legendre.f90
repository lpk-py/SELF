MODULE Legendre
! Legendre.f90 ( v2.1 - 16 November 2015 )
! 
! Module History 
! 
! o  (v1.0 - 19 January 2014 )
!    Put in procedures for evaluating the Legendre Polynomials and derivatives on [-1, 1].
!    Put in procedures for generating Legendre Gauss quadrature weights and nodes.
!
!
! o ( v2.1 - 16 November 2015 )
!
! =======================================================================================
USE ModelPrecision
USE ModelFlags
