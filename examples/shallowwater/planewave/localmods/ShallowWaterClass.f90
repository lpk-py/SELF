...
! ================================================================================================ !  
    ...
    TYPE ShallowWater
      ...
      PROCEDURE :: GetRelativeVorticity => GetRelativeVorticity_ShallowWater
      PROCEDURE :: SetRelativeVorticity => SetRelativeVorticity_ShallowWater
      PROCEDURE :: GetRelativeVorticityAtNode => GetRelativeVorticityAtNode_ShallowWater
      PROCEDURE :: SetRelativeVorticityAtNode => SetRelativeVorticityAtNode_ShallowWater
      PROCEDURE :: GetRelativeVorticityAtBoundary => GetRelativeVorticityAtBoundary_ShallowWater
      PROCEDURE :: SetRelativeVorticityAtBoundary => SetRelativeVorticityAtBoundary_ShallowWater
      PROCEDURE :: SetVorticityFluxAtBoundaryNode => SetVorticityFluxAtBoundaryNode_ShallowWater
      PROCEDURE :: GetVorticityFluxAtBoundaryNode => GetVorticityFluxAtBoundaryNode_ShallowWater
      PROCEDURE :: SetVorticityTendency => SetVorticityTendency_ShallowWater
      PROCEDURE :: GetVorticityTendency => GetVorticityTendency_ShallowWater
      
       ! Type Specific Routines
      PROCEDURE :: GlobalTimeDerivative => GlobalTimeDerivative_ShallowWater
      PROCEDURE :: GlobalVorticityTimeDerivative => GlobalVorticityTimeDerivative_ShallowWater
      PROCEDURE :: ForwardStepRK3 => ForwardStepRK3_ShallowWater
      PROCEDURE :: EdgeFlux => EdgeFlux_ShallowWater
      PROCEDURE :: RelativeVorticityEdgeFlux => RelativeVorticityEdgeFlux_ShallowWater
      PROCEDURE :: MappedTimeDerivative => MappedTimeDerivative_ShallowWater
      PROCEDURE :: VorticityTimeDerivative => VorticityTimeDerivative_ShallowWater 
      PROCEDURE :: CalculateSolutionAtBoundaries => CalculateSolutionAtBoundaries_ShallowWater
      PROCEDURE :: CalculateVorticityAtBoundaries => CalculateVorticityAtBoundaries_ShallowWater
      PROCEDURE :: CalculateBathymetryAtBoundaries => CalculateBathymetryAtBoundaries_ShallowWater
      PROCEDURE :: CalculateRelativeVorticity => CalculateRelativeVorticity_ShallowWater
...
!
!
  SUBROUTINE GetRelativeVorticity_ShallowWater( myDGSEM, iEl, theVorticity  )
 ! S/R GetVorticity
 !  
 !
 ! =============================================================================================== !
 ! DECLARATIONS
   ...
   REAL(prec), INTENT(out)         :: theVorticity(0:myDGSEM % nS, 0:myDGSEM % nP)
      ...
      CALL myDGSEM % vorticity(iEl) % GetSolutionWithVarID( 2, theVorticity )

 END SUBROUTINE GetRelativeVorticity_ShallowWater
!
!
!
 SUBROUTINE SetRelativeVorticity_ShallowWater( myDGSEM, iEl, theVorticity  )
 ! S/R SetVorticity
 !  
 !
 ! =============================================================================================== !
 ! DECLARATIONS
   ...
   REAL(prec), INTENT(in)             :: theVorticity(0:myDGSEM % nS, 0:myDGSEM % nP)
      ...
      CALL myDGSEM % vorticity(iEl) % SetSolutionWithVarID( 2, theVorticity )

 END SUBROUTINE SetRelativeVorticity_ShallowWater
!
!
!
 SUBROUTINE GetRelativeVorticityAtNode_ShallowWater( myDGSEM, iEl, i, j, theVorticity  )
 ! S/R GetVorticity
 !  
 !
 ! =============================================================================================== !
 ! DECLARATIONS
   ...
   REAL(prec), INTENT(out)         :: theVorticity
      ...
      CALL myDGSEM % vorticity(iEl) % GetSolutionAtNodeWithVarID( i, j, 2, theVorticity )

 END SUBROUTINE GetRelativeVorticityAtNode_ShallowWater
!
!
!
 SUBROUTINE SetRelativeVorticityAtNode_ShallowWater( myDGSEM, iEl, i, j, theVorticity  )
 ! S/R SetVorticity
 !  
 !
 ! =============================================================================================== !
 ! DECLARATIONS
   ...
   REAL(prec), INTENT(in)             :: theVorticity
      ...
      CALL myDGSEM % vorticity(iEl) % SetSolutionAtNodeWithVarID( i, j, 2, theVorticity )

 END SUBROUTINE SetRelativeVorticityAtNode_ShallowWater
!
!
!
 SUBROUTINE GetRelativeVorticityAtBoundary_ShallowWater( myDGSEM, iEl, boundary, theVorticity  )
 ! S/R GetVorticityAtBoundary
 !  
 !
 ! =============================================================================================== !
 ! DECLARATIONS
   ...
   REAL(prec), INTENT(out)         :: theVorticity(0:myDGSEM % nS)
      ...
      CALL myDGSEM % vorticity(iEl) % GetBoundarySolutionAtBoundaryWithVarID( boundary, 2, theVorticity )

 END SUBROUTINE GetRelativeVorticityAtBoundary_ShallowWater
!
!
!
 SUBROUTINE SetRelativeVorticityAtBoundary_ShallowWater( myDGSEM, iEl, boundary, theVorticity  )
 ! S/R SetVorticityAtBoundary
 !  
 !
 ! =============================================================================================== !
 ! DECLARATIONS
   ...
   REAL(prec), INTENT(in)             :: theVorticity(0:myDGSEM % nS)
      ...
      CALL myDGSEM % vorticity(iEl) % SetBoundarySolutionAtBoundaryWithVarID( boundary, 2, theVorticity )

 END SUBROUTINE SetRelativeVorticityAtBoundary_ShallowWater
!
!
!
 SUBROUTINE SetVorticityFluxAtBoundaryNode_ShallowWater( myDGSEM, iEl, boundary, i, theFlux  )
 ! S/R SetVorticityFluxAtBoundaryNode
 !  
 !
 ! =============================================================================================== !
 ! DECLARATIONS
   ...
   REAL(prec), INTENT(in)             :: theFlux(1:2)
      ...
      CALL myDGSEM % vorticity(iEl) % SetBoundaryFluxAtBoundaryNode( boundary, i, theFlux )

 END SUBROUTINE SetVorticityFluxAtBoundaryNode_ShallowWater
!
!
!
 SUBROUTINE GetVorticityFluxAtBoundaryNode_ShallowWater( myDGSEM, iEl, boundary, i, theFlux  )
 ! S/R GetVorticityFluxAtBoundaryNode
 !  
 !
 ! =============================================================================================== !
 ! DECLARATIONS
   ...
   REAL(prec), INTENT(out)         :: theFlux(1:2)
      ...
      CALL myDGSEM % vorticity(iEl) % GetBoundaryFluxAtBoundaryNode( boundary, i, theFlux )

 END SUBROUTINE GetVorticityFluxAtBoundaryNode_ShallowWater
!
!
!
 SUBROUTINE SetVorticityTendency_ShallowWater( myDGSEM, iEl, theTend  )
 ! S/R SetVorticityTendency
 !  
 !
 ! =============================================================================================== !
 ! DECLARATIONS
   ...
   CLASS(ShallowWater), INTENT(inout) :: myDGSEM
   INTEGER, INTENT(in)                :: iEl
   REAL(prec), INTENT(in)             :: theTend(0:myDGSEM % nS,0:myDGSEM % nP, 1:2)

      CALL myDGSEM % vorticity(iEl) % SetTendency( theTend )   

 END SUBROUTINE SetVorticityTendency_ShallowWater
!
!
!
  SUBROUTINE GetVorticityTendency_ShallowWater( myDGSEM, iEl, theTend  )
 ! S/R GetVorticityTendency
 !  
 !
 ! =============================================================================================== !
 ! DECLARATIONS
   ...
   CLASS(ShallowWater), INTENT(in) :: myDGSEM
   INTEGER, INTENT(in)             :: iEl
   REAL(prec), INTENT(out)         :: theTend(0:myDGSEM % nS,0:myDGSEM % nP, 1:2)

      CALL myDGSEM % vorticity(iEl) % GetTendency( theTend )   

 END SUBROUTINE GetVorticityTendency_ShallowWater
!
!
!==================================================================================================!
!--------------------------------- Type Specific Routines -----------------------------------------!
...
!
! 
 SUBROUTINE GlobalVorticityTimeDerivative_ShallowWater( myDGSEM, tn ) 
 ! S/R GlobalVorticityTimeDerivative_ShallowWater
 ! 
 !
 ! =============================================================================================== !
 ! DECLARATIONS
...
!$OMP DO
         DO iEl = 1, myDGSEM % mesh % nElems
            CALL myDGSEM % CalculateVorticityAtBoundaries( iEl ) 
         ENDDO 
!$OMP END DO 
!$OMP FLUSH( myDGSEM )  
...
!$OMP DO
         DO iEdge = 1, myDGSEM % mesh % nEdges
            CALL myDGSEM % RelativeVorticityEdgeFlux( iEdge, tn ) 
         ENDDO
!$OMP END DO
!$OMP FLUSH( myDGSEM )
...
!$OMP DO
         DO iEl = 1, myDGSEM % mesh % nElems
            CALL myDGSEM % VorticityTimeDerivative( iEl, tn )
         ENDDO
!$OMP END DO
!$OMP FLUSH( myDGSEM )
...
!$OMP END PARALLEL
 ...
 END SUBROUTINE GlobalVorticityTimeDerivative_ShallowWater
!
!
! 
...
!
!
SUBROUTINE RelativeVorticityEdgeFlux_ShallowWater( myDGSEM, iEdge, tn )
 ! S/R RelativeVorticityEdgeFlux
 ! 
 !
 ! =============================================================================================== !
 ! DECLARATIONS
   ...
   INTEGER :: e1, s1, e2, s2, iError, start, inc, nS, nP
   REAL(prec) :: flux(1:2)
   REAL(prec) :: relVorticityIn(0:myDGSEM % nS)
   REAL(prec) :: relVorticityOut(0:myDGSEM % nS)
   REAL(prec) :: planetaryVorticityIn(0:myDGSEM % nS)
   REAL(prec) :: planetaryVorticityOut(0:myDGSEM % nS)
   REAL(prec) :: inBathy(0:myDGSEM % nS,1:3)
   REAL(prec) :: inState(0:myDGSEM % nS,1:nSWeq)
   REAL(prec) :: exState(0:myDGSEM % nS,1:nSWeq)
   REAL(prec) :: x, y, h, zIn, zOut
   REAL(preC) :: nHat(1:2), nHatLength 
      ...
      CALL myDGSEM % GetBoundarySolutionAtBoundary( e1, s1, inState )
      CALL myDGSEM % GetRelativeVorticityAtBoundary( e1, s1, relVorticityIn )
      CALL myDGSEM % GetPlanetaryVorticityAtBoundary( e1, s1, planetaryVorticityIn )
      
      IF( e2 > 0 )then ! this is an interior edge
      
         k = start-inc
         CALL myDGSEM % GetBoundarySolutionAtBoundary( e2, s2, exState )
         CALL myDGSEM % GetRelativeVorticityAtBoundary( e2, s2, relVorticityOut )
         CALL myDGSEM % GetPlanetaryVorticityAtBoundary( e2, s2, planetaryVorticityOut )
         ...
         DO iNode = 0, nS ! Loop over the nodes
            ...
            flux(2) = VorticityFluxSolver( inState(iNode,:), exState(k,:), zIn, zOut, nHat )*nHatLength

            ! Store the flux for the elements which share this edge
            CALL myDGSEM % SetVorticityFluxAtBoundaryNode( e1, s1, iNode, flux )
            CALL myDGSEM % SetVorticityFluxAtBoundaryNode( e2, s2, k, -flux )
      ...
      ELSE ! this edge is a boundary edge
         ...
         DO iNode = 0, nS ! loop over the nodes on this edge
            ...
            ! Calculate the external state
            relVorticityOut(iNode) = GetExternalVorticity( nSWEq, nHat, x, y, tn, e2, &
                                                           relVorticityIn(iNode), &
                                                           myDGSEM % params )
            h = inBathy(iNode, 1) ! get the depth on the primary element boundary (s1)
            ! Calculate the external state
            exState(iNode,1:nSWEq) = GetExternalState( nSWEq, nHat, x, y, h, tn, e2, &
            ...
            zIn = relVorticityIn(iNode) + planetaryVorticityIn(iNode)
            zOut = relVorticityOut(iNode) + planetaryVorticityIn(iNode)
            ! Calculate the RIEMANN flux
            flux(2) = VorticityFluxSolver( inState(iNode,:), exState(iNode,:), zIn, zOut, nHat)*nHatLength
 ...
 END SUBROUTINE RelativeVorticityEdgeFlux_ShallowWater
!
!
!
...
!
!  
SUBROUTINE VorticityTimeDerivative_ShallowWater( myDGSEM, iEl, tn ) 
 ! S/R VorticityTimeDerivative
 ! 
 !
 ! =============================================================================================== !
 ! DECLARATIONS
   ...
   REAL(prec) :: rvort(0:myDGSEM % nS,0:myDGSEM % nP)
   REAL(prec) :: pvort(0:myDGSEM % nS,0:myDGSEM % nP)
   ...
   INTEGER    :: iS, iP, nS, nP, iEq
     ...
     CALL myDGSEM % GetPlanetaryVorticity( iEl, pVort )
     CALL myDGSEM % GetRelativeVorticity( iEl, rVort )
     tend = ZERO
     ...
     DO iP = 0,nP ! Loop over the y-points
        ...
        DO iS = 0,nS ! Loop over the x-points
           ...
           xF = u(iS,iP)*(rVort(iS,iP) + pVort(iS,iP))
           yF = v(iS,iP)*(rVort(iS,iP) + pVort(iS,iP))
        ...
        ! Get the "west" flux at iP
        CALL myDGSEM % GetVorticityFluxAtBoundaryNode( iEl, 4, iP, fL )

        ! Get the "east" flux at iP
        CALL myDGSEM % GetVorticityFluxAtBoundaryNode( iEl, 2, iP, fR )
         
        ! At this y-level, calculate the DG-advective derivative
            sContFluxDer = DGSystemDerivative(  nS, dMatX, qWeightX, fL(2), fR(2), &
                                               sContFlux, lwest, least )


         DO iS = 0, nS ! Loop over the x-points
            tend(iS, iP, 2) = -sContFluxDer(iS)
         ENDDO ! Loop over the x-points
     ...
     DO iS = 0,nS ! Loop over the x-points
        ...
        !! Get the "south" flux at iS
        CALL myDGSEM % GetVorticityFluxAtBoundaryNode( iEl, 1, iS, fL )

        ! Get the "north" flux at iS
        CALL myDGSEM % GetVorticityFluxAtBoundaryNode( iEl, 3, iS, fR )

        ! At this x-level, calculate the y-DG-advective derivative
         pContFluxDer = DGSystemDerivative(  nP, dMatY, qWeightY, fL(2), fR(2), &
                                             pContFlux, lsouth, lnorth  )
     
         
         DO iP = 0, nP ! Loop over the y-points
            CALL myDGSEM % mesh % GetJacobianAtNode( iEl, J, iS, iP )
            tend(iS, iP, 2) = ( tend(iS, iP, 2)- pContFluxDer(iP) )/J
         ENDDO ! Loop over the x-points

      
     ENDDO ! iP
         
     CALL myDGSEM % SetVorticityTendency( iEl, tend )

 END SUBROUTINE VorticityTimeDerivative_ShallowWater            
!
!
!                         
...
!
!
 FUNCTION VorticityFluxSolver( inState, outState, vortin, vortout, nHat ) RESULT( numFlux )
 ! FUNCTION VorticityFluxSolver 
 !
 !  Uses an upwind flux to approximate the flux of vorticity.
 ! =============================================================================================== !
 ! DECLARATIONS
   IMPLICIT NONE
   REAL(prec) :: inState(1:nSWEq)
   REAL(prec) :: outState(1:nSWEq)
   REAL(prec) :: vortin, vortout
   REAL(prec) :: nHat(1:2) ! normal direction
   REAL(prec) :: numFlux
   ! LOCAL
   REAL(prec) :: uL, uR, vL, vR, uOut, uIn
      ...
      numFlux = HALF*( uOut*vortOut + uIn*vortIn - max( abs(uOut),abs(uIn) )*( vortOut - vortIn ) )
    
 END FUNCTION VorticityFluxSolver
!
!
! 
 ...
 ! DECLARATIONS
   ...
   REAL(prec) :: uNorm, fac
      ...
      ELSEIF( locParams % ModelFormulation == SKEW_SYMMETRIC )then
         ...
         aS(1) = ( HALF*(uR*uR + vR*vR) + locg*pR + &
                   HALF*(uL*uL + vL*vL) + locg*pL )*nHat(1)

         aS(2) = ( HALF*(uR*uR + vR*vR) + locg*pR + &
                   HALF*(uL*uL + vL*vL) + locg*pL )*nHat(2)
...
! 
 ...
 ! DECLARATIONS
   ...
   REAL(prec) :: KE, g 
      ...
      ELSEIF( params % modelFormulation == SKEW_SYMMETRIC ) then

         KE = (solAtX(1)*solAtX(1) + solAtX(2)*solAtX(2))*HALF
...
!               
 ...
 ! DECLARATIONS
   ...
   REAL(prec) :: lDrag, h, dhdx, dhdy, g
     ...
     IF( params % ModelFormulation == SKEW_SYMMETRIC .OR. &
         params % ModelFormulation == LINEAR ) then
   ...
   TYPE( SWParams ) :: locParams
      ...
      c = locParams % g*h
       ...
       ELSEIF( bcFlag == RADIATION ) then
          ...
          extState(3) = 0.01_prec*exp(-HALF*( (x-0.1_prec) + (y-0.1_prec) -c*t )**2/(0.1_prec**2) )
...
!
!
FUNCTION GetExternalVorticity( nEqn, nHat, x, y, t, bcFlag, intVort, locParams) RESULT( extVort )
 ! S/R GetExternalVorticity
 ! 
 ! =============================================================================================== !
 ! DECLARATIONS
   IMPLICIT NONE
   ...
   TYPE( SWParams ) :: locParams
       ...
       ELSE       
         ...
         PRINT*, 'FUNCTION : GetExternalVorticity : Invalid bcflag =', bcflag
         extVort = ZERO
         
       ENDIF

        
 END FUNCTION GetExternalVorticity
!
!
!
...
!
 ...
 ! DECLARATIONS
   ...
   REAL(prec) :: localVorticity(0:myDGSEM % nS, 0:myDGSEM % nP)
      ...
      CALL myDGSEM % GetRelativeVorticity( iEl, localVorticity )
  ...
  ! LOCAL
   ...
   INTEGER       :: iS, iP, iEq, nS, nP
     ...
     DO iEl = 1, myDGSEM % mesh % nElems
        ...
        CALL myDGSEM % GetRelativeVorticity( iEl, plv )
        WRITE( fUnit, REC=thisRec ) plv
        thisRec = thisRec+1
  ...
  ! LOCAL
   ...
   INTEGER       :: iS, iP, iEq, nS, nP
     ...
     DO iEl = 1, myDGSEM % mesh % nElems
        ...
        READ( fUnit, REC=thisRec ) plv
        thisRec = thisRec+1
        CALL myDGSEM % SetRelativeVorticity( iEl, plv )
